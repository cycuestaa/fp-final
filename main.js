...
var author$project$Main$LatLng = F2(
	function (lat, lng) {
...
var author$project$Main$blankModel = function (gkey) {
	return {
		center: A2(author$project$Main$LatLng, 39.4, -0.41),
...
var author$project$Main$init = function (gkey) {
	return _Utils_Tuple2(
		author$project$Main$blankModel(gkey),
		elm$core$Platform$Cmd$none);
};
var author$project$Main$Click = {$: 'Click'};
var author$project$Main$ReceiveValue = function (a) {
	...
	return elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				author$project$Main$firebaseRead(author$project$Main$ReceiveValue)
			]));
};
		...
		switch (msg.$) {
			case 'OnDragEnd':
				...
				var _n1 = A2(
					elm$core$Debug$log,
					'detail',
					elm$core$Debug$toString(detail));
			...
			default:
				var value = msg.a;
				var _n3 = elm$core$String$toInt(value);
				if (_n3.$ === 'Just') {
					var n = _n3.a;
					return _Utils_Tuple2(
						_Utils_update(
...
var author$project$Main$OnDragEnd = function (a) {
	return {$: 'OnDragEnd', a: a};
};
var author$project$Main$MapBounds = F4(
...
var author$project$Main$decodeMapBounds = A5(
	elm$json$Json$Decode$map4,
	author$project$Main$MapBounds,
...
var author$project$Main$gmarker = function (_n0) {
	var lat = _n0.lat;
	var lng = _n0.lng;
	return A3(
		elm$html$Html$node,
...
var author$project$Main$gmap = function (model) {
	return A3(
		elm$html$Html$node,
		'google-map',
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$attribute, 'api-key', model.gkey),
				A2(
				elm$html$Html$Attributes$attribute,
				'latitude',
				elm$core$String$fromFloat(model.center.lat)),
				A2(
				elm$html$Html$Attributes$attribute,
				'longitude',
				elm$core$String$fromFloat(model.center.lng)),
				...
				A2(
					...
					A2(
						...
						_List_fromArray(
							['detail', 'bounds']),
						author$project$Main$decodeMapBounds)))
			]),
		_List_fromArray(
			[
				author$project$Main$gmarker(model.center)
			]));
};
var author$project$Main$inputBox = function (x) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
...
var author$project$Main$stackBox = function (x) {
	return A2(
		elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Community Care Resources')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Welcome! We have aggregated food and shelter resources around Chicago.')
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('Food Pantries!')
							])),
						A2(
						elm$html$Html$button,
						_List_fromArray(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Vacant/Abandoned Buildings')
							])),
						A2(
						elm$html$Html$div,
						_List_fromArray(
							...
							_Utils_ap(
								...
								_List_fromArray(
									[
										...
										function () {
											var _n0 = model.title;
											return elm$html$Html$text(' fill something');
										}()),
						...
						_List_fromArray(
							[
								author$project$Main$gmap(model)
							]))
					])),
				A2(
				elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('by ccuestaa')
							]))
					]))
			]),
